...
// needs comments to be setup inside of all scss files, set individually for every component
gulp.task('sassdoc', function () {
	var options = {
		dest: './sassdoc',
	};
	return gulp.src(paths.sassany)
...
gulp.task("icons", ['images'], function () {
	return gulp.src("./dist/images/favicon_starter.png").pipe(favicons({
		appName: "My App",
